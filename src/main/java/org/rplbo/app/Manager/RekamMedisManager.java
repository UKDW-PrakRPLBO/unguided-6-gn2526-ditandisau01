...
public class RekamMedisManager {
    ...
    public boolean tambahRekamMedis(String namaDokter, String namaPasien, String diagnosis, String tanggal) {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(query)) {
            ...
            System.err.println("Error tambah rekam medis: " + e.getMessage());
            return false;
        }
    }
    ...
    public List<RekamMedis> getAllRekamMedis() {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(query);
            ...
            while (rs.next()) {
                // Constructor RekamMedis: namaPasien, diagnosis, tanggal, id, namaDokter
            ...
            System.err.println("Error ambil data rekam medis: " + e.getMessage());
        }
    ...
    public boolean editRekamMedis(int idRekamMedis, String diagnosisBaru) {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(query)) {
            ...
            System.err.println("Error edit rekam medis: " + e.getMessage());
            return false;
        }
    }
    ...
    public boolean hapusRekamMedis(int idRekamMedis) {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(query)) {
            ...
            System.err.println("Error hapus rekam medis: " + e.getMessage());
            return false;
        }
    }

    // --- 5. READ (Berdasarkan Nama Pasien) ---
    public List<RekamMedis> cariRekamMedisPasien(String nama) {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(query)) {
            ...
            System.err.println("Error cari rekam medis pasien: " + e.getMessage());
        }
        return resultList;
    }
}